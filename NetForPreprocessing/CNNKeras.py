...
validation_data_directory = 'data/evaluation'

number_of_training_images = 2600
number_of_validation_images = 150
...
train_generator = train_datagenerator.flow_from_directory('data/training', target_size=(image_width, image_height), batch_size=batch_size, class_mode='binary')

validation_datagenerator = ImageDataGenerator(rescale=1./255)
validation_generator = validation_datagenerator.flow_from_directory('data/evaluation', target_size=(image_width, image_height), batch_size=batch_size, class_mode='binary')
